...
vim.keymap.set("n", "<leader>e", ':lua vim.diagnostic.open_float()<CR>', { desc = 'Show error on current line'})
...
vim.keymap.set('n', '<leader>fr', ':lua vim.lsp.buf.rename()<CR>', { desc = 'Find and replace elements'})
